...
# ─── CODICI SDI ─────────────────────────────────────────────
SDI_CODES = [
    '0000000','07ZBNDO','0G6TBBX','0KDMVIB','10ZKECO','2LCMINU','2R4GTO8','38P86EY','3G3OPYL',
...
.logo-sub{font-size:9px;color:#999;letter-spacing:1px;text-transform:uppercase;margin-bottom:24px}
...
<div class="card">
  ...
  <div class="logo-row">
    <img src="data:image/png;base64," alt="Il Mannarino" style="height:80px;object-fit:contain;background:#fff;">
  </div>
...
def search_clienti():
    ...
    n8n_url = os.environ.get('N8N_SEARCH_URL_CLOUD', 'https://manna23.app.n8n.cloud/webhook/proforma/cerca-clienti')
...
def genera():
    ...
    n8n_storage_url = os.environ.get('N8N_STORAGE_URL_CLOUD', 'https://manna23.app.n8n.cloud/webhook/proforma/salva-pdf')
    if n8n_storage_url:
